...
- Update publications with links to papers, preprints, code, and related pages; keep venue and track details consistent with news. Keep the publication timeline in chronological order, oldest first. Use the confirmed milestone dates: 22 May 2026 for Improved Dual Attack and 7 July 2026 for the IEEE QCE paper. Do not replace these with arXiv submission dates.
